...
<head>
    ...
    <title>Prepress Tracker</title>

    
    <meta name="description" content="Start your development with a Dashboard for Bootstrap 5" />
    <meta name="keywords" content="dashboard, material, material design, bootstrap 5 dashboard, bootstrap 5 design, bootstrap 5">
    <!-- Canonical SEO -->
    <link rel="canonical" href="../item/materio-bootstrap-html-admin-template/">
...
<span style="color:var(--bs-primary);">
  <svg width="30" height="24" viewBox="0 0 250 196" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <span class="app-brand-text demo text-heading fw-semibold">Prepress</span>
  </a>
  <!-- /Logo -->
  <div class="authentication-inner row m-0">
    ...
    <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg position-relative py-sm-5 px-4 py-4">
      ...
      <div class="w-px-400 mx-auto pt-5 pt-lg-0">
        <!------giving nav tabs -->
        <h4 class="mb-2">Welcome to Prepress! 👋</h4>
        <p class="mb-4">Please Receive and Release on hand orders carefully</p>
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
          <li class="nav-item" role="presentation">
            <button class="nav-link active" id="pills-Release-tab" data-bs-toggle="pill" data-bs-target="#pills-Release" type="button" role="tab" aria-controls="pills-Release" aria-selected="true">Release</button>
          </li>
          <li class="nav-item" role="presentation">
    ...
    <div class="card-body">
      ...
      <div class="card-body">
        For Admin login  <a href="Admin_login.html">click here
        <i class="mdi mdi-account mdi-36px"></i>
        <!-- <p class="icon-name text-capitalize text-truncate mb-0 mt-2">Admin</p> -->
      </a>
      </div>
...
<!-- / Content -->
  ...
  <script>// Get all textarea elements with the class "form-control" and the id "textarea".
    ...
    // Get the CSS style element.
    const cssStyleElement = document.getElementById('css-style');
    
    // Initialize the number of rows in the textareas.
    let rows = 3;
    
    // Set the initial CSS style for the textareas.
    cssStyleElement.textContent = `
    textarea.form-control#textarea {
      height: ${rows * 15}px;
    }`;
    
    // Add an event listener to all textareas to detect changes in the user's input.
    textareas.forEach(textarea => {
      textarea.addEventListener('input', () => {
        // Split the user's input into lines.
        const lines = textarea.value.split('\n');
    
        // Update the number of rows in the textarea based on the number of lines.
        rows = Math.min(lines.length, 25);
    
        // Update the CSS style for the textarea.
        cssStyleElement.textContent = `
      textarea.form-control#textarea {
        height: ${rows * 15}px;
      }`;
        ...
        // Resize the textarea.
        textarea.style.height = `${rows * 15}px`;
      });
    });
    </script>
